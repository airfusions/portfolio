...
import { Brain, Github, Twitter, Mail, ExternalLink, Network, Cpu, TextIcon as Telegram } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <Image
              ...
              alt="Shreyansh Parashar"
              fill
              className="object-cover"
              onError={(e) => {
                e.currentTarget.src = "https://via.placeholder.com/400x400.png?text=SP"
              }}
            />
          </motion.div>
          <div>
            ...
            >
              ...
              <Link 
                href="https://github.com/airfusions" 
                target="_blank"
                className="text-gray-300 hover:text-cyan-400 transition-colors flex items-center gap-2 bg-gray-800/50 px-4 py-2 rounded-full"
              >
                <Github size={20} />
            ...
            {[
              {
                ...
                link: "https://github.com/airfusions/kage-ai"
              },
              {
      ...
      <section id="contact" className="relative py-20">
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          >
            <Link 
              href="mailto:shreyanshparashar20@gmail.com"
            ...
            <Link 
              href="https://t.me/airfusions"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-gray-900 px-6 py-3 rounded-lg hover:opacity-90 transition-opacity"
            >
              <Telegram size={20} />
              Telegram
            </Link>
